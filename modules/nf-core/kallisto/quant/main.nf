process KALLISTO_QUANT {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/kallisto:0.48.0--h1b792b2_1':
        'biocontainers/kallisto:0.48.0--h1b792b2_1' }"
    ...
    # Copy BAM file if generated
    if [ -f "${prefix}/pseudoalignments.bam" ]; then
        cp ${prefix}/pseudoalignments.bam ${meta.id}.bam
    fi
