process KALLISTO_QUANT {
    ...
    tuple val(meta), path("${prefix}/pseudoalignments.bam"), emit: bam, optional: true
    tuple val(meta), path("${prefix}/pseudoalignments.bam.bai"), emit: bai, optional: true
    ...
    # BAM and BAI files are emitted directly from the sample directory (no copying needed)
