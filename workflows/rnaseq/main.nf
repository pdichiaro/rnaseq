    ...
    if (params.aligner == 'star' && !params.skip_quantification_method && quantification_methods.size() > 0) {
        ...
        if (quantification_methods.contains('rsem')) {
            ...
            if (!params.skip_qc & !params.skip_deseq2_qc) {
                ...
                if (normalization_methods.contains('invariant_genes')) {
                    ...
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                if (normalization_methods.contains('all_genes') || (!normalization_methods.contains('invariant_genes') && !normalization_methods.contains('all_genes'))) {
                    ...
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files = ch_normalization_multiqc_files.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
        ...
        if (quantification_methods.contains('salmon')) {
            ...
            if (!params.skip_qc & !params.skip_deseq2_qc) {
                ...
                ch_normalization_multiqc_files_salmon = Channel.empty()
                ...
                if (normalization_methods.contains('invariant_genes')) {
                    ...
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES.out.read_dist_norm_txt.collect())
                ...
                if (normalization_methods.contains('all_genes') || (!normalization_methods.contains('invariant_genes') && !normalization_methods.contains('all_genes'))) {
                    ...
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_salmon = ch_normalization_multiqc_files_salmon.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                // Mix the normalization results into main channels
                ch_multiqc_files = ch_multiqc_files.mix(ch_normalization_multiqc_files_salmon)
        ...
        if (quantification_methods.contains('genome')) {
            ...
            if (!params.skip_qc & !params.skip_deseq2_qc) {
                ...
                ch_normalization_multiqc_files_genome = Channel.empty()
                ...
                if (normalization_methods.contains('invariant_genes')) {
                    ...
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                if (normalization_methods.contains('all_genes') || (!normalization_methods.contains('invariant_genes') && !normalization_methods.contains('all_genes'))) {
                    ...
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_genome = ch_normalization_multiqc_files_genome.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                // Mix the normalization results into main channels
                ch_multiqc_files = ch_multiqc_files.mix(ch_normalization_multiqc_files_genome)
    ...
    if (!params.skip_alignment && params.aligner == 'hisat2') {
        ...
        if (quantification_methods.contains('genome') && !params.skip_quantification_method) {
            ...
            if (!params.skip_qc & !params.skip_deseq2_qc) {
                ...
                ch_normalization_multiqc_files_hisat2 = Channel.empty()
                ...
                if (normalization_methods.contains('invariant_genes')) {
                    ...
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_INVARIANT_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                if (normalization_methods.contains('all_genes') || (!normalization_methods.contains('invariant_genes') && !normalization_methods.contains('all_genes'))) {
                    ...
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.sample_distances_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_all_genes_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.pca_top_genes_txt.collect())
                    ch_normalization_multiqc_files_hisat2 = ch_normalization_multiqc_files_hisat2.mix(NORMALIZE_DESEQ2_QC_ALL_GENES_ALIGNMENT.out.read_dist_norm_txt.collect())
                ...
                // Mix the normalization results into main channels
                ch_multiqc_files = ch_multiqc_files.mix(ch_normalization_multiqc_files_hisat2)
