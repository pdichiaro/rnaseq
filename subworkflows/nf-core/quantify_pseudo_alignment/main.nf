...
workflow QUANTIFY_PSEUDO_ALIGNMENT {
    ...
    TXIMPORT_MERGE_COUNTS (
        ...
        TXIMETA_TXIMPORT.out.counts_gene_length_scaled,
        TXIMETA_TXIMPORT.out.counts_gene_scaled,
    ...
    counts_gene_length_scaled     = TXIMPORT_MERGE_COUNTS.out.counts_gene_length_scaled //    path: tximport.merged.gene_counts_length_scaled.tsv
    counts_gene_scaled            = TXIMPORT_MERGE_COUNTS.out.counts_gene_scaled   //    path: tximport.merged.gene_counts_scaled.tsv
