...
######## PARAMS #########
sample_file=/mnt/ngs_ricerca/dichiarop/Master_scripts/BulkRNAseq_test/samplesheet.csv
outdir=/mnt/ngs_ricerca/dichiarop/Data/BulkRNAseq_test/
...
GTF=$UsefulData/reference_genome/gencode.v47.basic.annotation.gtf 
